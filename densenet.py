...
class DenseNet3(nn.Module):
    def __init__(self, depth, num_classes, growth_rate=12,
                 reduction=0.5, bottleneck=True, dropRate=0.0,margin=2):
        ...
        self.Angle_loss = AngleLinear(234,num_classes)
    ...
    def forward(self, x,target = None):
        ...
        #print(self.Angle_loss(out))
        return self.Angle_loss(out),features,out
